...
app.layout = html.Div(children=[
    html.Div(children=[
        html.H3(html.I('Projet Gabriel BAR'), style={'text-align': 'center', 'font-size': '2.5em', 'background-image': 'linear-gradient(to right, blue, red)', '-webkit-background-clip': 'text', 'color': $
        ],
	style={
               	'color': 'red',
